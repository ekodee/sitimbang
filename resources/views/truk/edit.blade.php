                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                @enderror"
                                    autofocus placeholder="AB XXXX ABC" value="{{ $truk->no_polisi }}">
                                @error('no_polisi')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="jenis_truk" id="jenis_truk"
                                    class="form-select @error('jenis_truk')
                                    is-invalid
                                @enderror">
                                    <option disabled selected>Pilih Jenis Truk</option>
                                    <option value={{ $truk->jenis_truk }}
                                        {{ old('jenis_truk') == 'Heavy' ? 'selected' : '' }}>Heavy
                                    </option>
                                    <option value={{ $truk->jenis_truk }}
                                        {{ old('jenis_truk') == 'Medium' ? 'selected' : '' }}>Medium
                                    </option>
                                    <option value={{ $truk->jenis_truk }}
                                        {{ old('jenis_truk') == 'Light' ? 'selected' : '' }}>Light
                                    </option>
                                </select>
                                @error('no_polisi')
                                    <small class="text-danger">{{ $message }}</small>
